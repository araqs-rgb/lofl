 ...
 * Use the [FinalMessageFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FinalMessageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FinalMessageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FinalMessageFragment().apply {
